...
module {
  ...
  /// @deprecated Use `Int.toInt8` instead.
  ...
  ///
  /// Traps on overflow/underflow.
  /// @deprecated Use `Int16.toInt8` instead.
  ...
  ///
  /// Traps on overflow/underflow.
  /// @deprecated Use `Int32.toInt8` instead.
  ...
  ///
  /// Traps on overflow/underflow.
  /// @deprecated Use `Int64.toInt8` instead.
